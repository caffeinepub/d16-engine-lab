...
export class Backend implements backendInterface {
    ...
    async createScenario(arg0: ScenarioInput): Promise<bigint> {
    ...
    async deleteScenario(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getScenario(arg0: bigint): Promise<Scenario> {
        if (this.processError) {
            try {
    ...
    async listAllScenarios(): Promise<Array<Scenario>> {
        if (this.processError) {
            try {
                const result = await this.actor.listAllScenarios();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateScenario(arg0: bigint, arg1: ScenarioInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateScenario(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
